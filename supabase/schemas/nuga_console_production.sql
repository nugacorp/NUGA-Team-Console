...
create table nuga_console_production.agent_profiles (
...
alter table nuga_console_production.agent_profiles enable row level security;
alter table nuga_console_production.agent_profiles force row level security;
